...
# A full comparison between the two buffers is not possible due to the time constraints of the project but it would be interesting to see how the two compare
