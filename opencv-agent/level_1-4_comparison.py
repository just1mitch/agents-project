...
# OpenCV Agent data
opencvpath = PurePath("opencv-agent/experiment-data/level_1-4_dump.tsv")
...
# DDQN Agent data
ddqnpath = PurePath("opencv-agent/experiment-data/ddqn_1-4_dump.txt")
...
# PPO Agent data
ppopath = PurePath("opencv-agent/experiment-data/ppo_1-4_dump.txt")
...
plt.legend()
plt.savefig(PurePath("opencv-agent/experiment-data/level_1-4_comparison.png"))
